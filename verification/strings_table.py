...
STRINGS = [
    ...
    ("map_none_download", "To see streets here, download %1$s next time you have Wi-Fi.",
     "Pour voir les rues ici, téléchargez %1$s la prochaine fois que vous aurez du Wi-Fi.",
     "لرؤية الشوارع هنا، نزّل %1$s في المرة القادمة التي يتوفر فيها Wi-Fi."),
    ("map_none_download_sized",
     "To see streets here, download %1$s (about %2$s) next time you have Wi-Fi.",
     "Pour voir les rues ici, téléchargez %1$s (environ %2$s) la prochaine fois que vous aurez du Wi-Fi.",
     "لرؤية الشوارع هنا، نزّل %1$s (حوالي %2$s) في المرة القادمة التي يتوفر فيها Wi-Fi."),
    ("map_none_explanation",
     "Map regions are downloaded once while you’re online, then work offline forever after.",
     "Les régions cartographiques se téléchargent une fois en ligne, puis fonctionnent hors ligne pour toujours.",
     "تُنزَّل مناطق الخريطة مرة واحدة أثناء الاتصال، ثم تعمل بدون اتصال إلى الأبد."),
    ("map_open_region_list", "Open region list", "Ouvrir la liste des régions",
     "فتح قائمة المناطق"),
    ...
    ("about_declination_note",
     "Magnetic declination across Morocco and Mauritania differs from the current model by under 0.2°, which is smaller than the model’s own uncertainty.",
     "Au Maroc et en Mauritanie, la déclinaison magnétique s’écarte du modèle actuel de moins de 0,2°, soit moins que l’incertitude propre au modèle.",
     "يختلف الانحراف المغناطيسي في المغرب وموريتانيا عن النموذج الحالي بأقل من 0.2 درجة، وهو أقل من هامش عدم اليقين في النموذج نفسه."),
    ("about_offline", "This app never uses the internet. It has no internet permission.",
     "Cette application n’utilise jamais Internet. Elle n’en a pas l’autorisation.",
     "لا يستخدم هذا التطبيق الإنترنت إطلاقاً، ولا يملك إذناً بذلك."),
